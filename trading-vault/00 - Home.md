...
## Current state (as of 2026-09-14, 12:30 PM ET — **the day's only trade** was the 9:35 SMH buy that refilled slot 2 one session after Friday's sale; the account is back to ~100% deployed. Marks refreshed at the midday check; **nothing traded since**)
...
| Account value | **$726.85** — equity $458.67, options $266.00, cash $2.18. **+11.7%** vs $650.54 contributed, or **−20.0%** vs $909.02 if the disputed cash is a deposit. The second figure is the honest one until the owner confirms |
| Realized P&L to date | **−$155.84** (equity legs **−$26.72**; options sleeve **−$129.12**) — **unchanged today; nothing was sold** |
| Unrealized P&L | **−$26.29** on $751.00 of cost — the **Nov 66C gave back its first-ever green mark**, $304.00 → **$266.00 (−$29.00)** in three hours, delta 0.537 → 0.503; **SMH +$3.25** above its 9:35 fill; XLE equity −$0.55 |
| Slot 1 | **XLE** — equity 1.632641 sh @ $65.54 ($107.00 basis) **plus** 1 Nov 20 $66C @ $2.95 ($295.00). Rank 1 for a **fifth consecutive session** at **+4.58% 10d**, RSI 66.1, **$1.42 (2.23%) above its 20-SMA**, **+6.68% over 20 days** — the only positive 10-day return in the universe, and ~4× the runner-up, which is negative |
| Slot 2 | **SMH** — 0.647844 sh @ $538.7099 ($349.00 basis), bought 9:35 today. Re-qualified on the 09-11 close ($568.53, **+0.90% over its 20-SMA**) one session after being sold at $566.80. **Caveat: on live prices it still fails §3** — **$543.73 at 12:30, −4.36% on the day** — and is the likely sell at tomorrow's re-rank, though it has recovered **+$3.25** off the gap it was bought into |
| **Ranks** | **Fresh as of the 2026-09-11 close** (scored this morning at 9:31) |
| Cash | **$2.18, all settled** — the buffer. `unsettled_funds` read **$0.0000** at 9:30 with the full $351.18 spendable, so the whole slot-2 tranche went to work today. The account is **99.7% deployed** |
| Options sleeve | **Held: 1 XLE Nov 20 $66C, 0.503Δ, 67 DTE, $295.00 cost / $266.00 mark.** Premium at risk = **36.6%** of account against the §4 50% cap. **All three close conditions pass wide** — XLE still rank 1, 20d **+5.32%** (live; the fall from +6.68% is the window rolling, not price), 67 DTE (floor 21) |
| Circuit-breaker | $325 (50% of contributed capital) — **checked first, before any order**; account at **2.24×** ($401.85 headroom). Clear. *(Also clear at **1.60×** against the $454.51 breaker the deposit reading would imply)* |
| **Concentration** | **XLE is 51.2% of the account** ($106.46 equity + $266.00 premium), **SMH 48.5%** ($352.25). Both compliant under §2 — up to 100% is permitted for the top-ranked asset, and this concentration arrived from the system, which is the test §2 actually applies |
| **Sleeve scorecard** | **0-for-2 closed, −$129.12** (Oct $59C −$63.08; Nov $65C −$66.04), **trade #3 open at −$29.00** — it was **+$9.00 at 9:35, the first green mark any sleeve trade has ever shown, and gave all of it back by lunchtime** — vs **−$26.72** from every equity rotation combined. Still not evidence the design works; it is evidence the design has not yet failed a third time |
